                ...
                <form onSubmit={handleSaveItem} className="space-y-4">
                    ...
                    {formLocationType === 'vriezer' && (
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <input type="date" className="w-24 sm:w-32 p-1 text-sm bg-white dark:bg-gray-700 dark:text-white border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"  value={formData.ingevrorenOp} onChange={e => setFormData({...formData, ingevrorenOp: e.target.value})} required /></div>
                            <div className="space-y-1"><label className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase">THT (Optioneel)</label>
                            <input type="date" className="w-24 sm:w-32 p-1 text-sm bg-white dark:bg-gray-700 dark:text-white border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"  value={formData.houdbaarheidsDatum} onChange={e => setFormData({...formData, houdbaarheidsDatum: e.target.value})} /></div>
                        </div>
                    )}
